...
import { shareToFacebook, shareToTelegram, shareGeneral, updateMetaTagsForPost } from '../utils/shareUtils';
...
const BlogPost: React.FC<BlogPostProps> = ({ post, onBack }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const metaTagsToRemove = document.querySelectorAll('meta[data-dynamic="true"]');
